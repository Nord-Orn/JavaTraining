 ...
 * Напишите метод, который запишет массив, возвращенный предыдущим методом.
 * Обработайте ошибки с помощью try-catch конструкции. В случае возникновения исключения,
 * оно должно вписаться влог файл.
 */
...
public class Task5 {
    ...
    public static void main(String[] args) {
        ex5("C:\\Users\\user\\Desktop\\Мое обучение\\Git repositories\\Java_training");
    }
