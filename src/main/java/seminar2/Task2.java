 ...
 * Пример: дана строка -"aaabbcdd", должно получиться -"a3b2cd2"
 */
...
public class Task2 {
    ...
    private static void group1(String str) {
        ...
        char current = array[0];
        char next = 0;
        StringBuilder res = new StringBuilder(String.valueOf(current)); //String.valueOf(current) преобразует число в символ
